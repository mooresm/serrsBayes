...
This data is in the binary `.spc` file format used by Grams/AI ^[<http://ftirsearch.com/Features/converters/SPCFileFormat.asp>]. Fortunately, we can use the R package **hyperSpec** to read this file and plot the spectrum:
