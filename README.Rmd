...
```{r echo=FALSE, message=FALSE, warning=FALSE, fig.align='right', fig.asp=1, out.width='100px',out.height='100px'}
tmp <- tempfile()
...
library(hexSticker)
sticker(expression({plot(wavenumbers, spectra[1,], type='l', ann=FALSE, xaxt='n', yaxt='n', bty='n', lwd=2, col="#000000C0", xlim=c(600,1700))
...
}}),package="serrsBayes",p_size=8, s_x=0.68, s_y=.8, s_width=2.4, s_height=2, p_color = "#0000FFC0", h_color = "#0000FFC0", h_fill ="#FFFFFFFF", filename = "inst/image/README-logo.png")
