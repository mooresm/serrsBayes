...
`serrsBayes` provides model-based quantification of surface-enhanced resonance Raman spectroscopy (SERRS), using sequential Monte Carlo (SMC) algorithms. Development of this software was supported by the UK 
